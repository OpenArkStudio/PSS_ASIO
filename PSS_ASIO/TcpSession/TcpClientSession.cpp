...
void CTcpClientSession::regedit_bridge_session_id(uint32 connect_id)
{
    PSS_UNUSED_ARG(connect_id);
    if (EM_SESSION_STATE::SESSION_IO_BRIDGE != io_state_)
    {
            ...
            && io_bridge_result.bridge_type_ == ENUM_IO_BRIDGE_TYPE::IO_BRIDGE_BATH)
        {
            ...
            PSS_LOGGER_DEBUG("[CTcpClientSession::regedit_bridge_session_id]connect_id={} IO_BRIDGE_BATH, io_bridge_connect_id:{},the bridge is set successfully.",
            ...
            && io_bridge_result.bridge_type_ == ENUM_IO_BRIDGE_TYPE::IO_BRIDGE_FROM)
        {
            ...
            if (io_bridge_result.io_bridge_id_ == io_bridge_result.io_from_id_)
            {
                ...
                PSS_LOGGER_DEBUG("[CTcpClientSession::regedit_bridge_session_id]connect_id={} ID from, io_bridge_connect_id:{},the bridge is set successfully.",
                    connect_id_, io_bridge_connect_id_);
            }
            else
            {
                ...
                PSS_LOGGER_DEBUG("[CTcpClientSession::regedit_bridge_session_id]connect_id={} ID to, io_bridge_connect_id:{},the bridge is set successfully.",
                    connect_id_, io_bridge_connect_id_);
            }
        }
    }
...
void CTcpClientSession::handle_connect(const asio::error_code& ec, tcp::resolver::results_type::iterator endpoint_iter)
{
    if (!ec)
    {
            ...
            && io_bridge_result.bridge_type_ == ENUM_IO_BRIDGE_TYPE::IO_BRIDGE_BATH)
        {
            ...
            PSS_LOGGER_DEBUG("[CTcpClientSession::handle_connect]connect_id={} IO_BRIDGE_BATH, io_bridge_connect_id:{},the bridge is set successfully.",
                connect_id_, io_bridge_connect_id_);
            ...
            && io_bridge_result.bridge_type_ == ENUM_IO_BRIDGE_TYPE::IO_BRIDGE_FROM)
        {
            ...
            if (io_bridge_result.io_bridge_id_ == io_bridge_result.io_from_id_)
            {
                ...
                PSS_LOGGER_DEBUG("[CTcpClientSession::handle_connect]connect_id={} ID from, io_bridge_connect_id:{},the bridge is set successfully.",
                    connect_id_, io_bridge_connect_id_);
            }
            else
            {
                ...
                PSS_LOGGER_DEBUG("[CTcpClientSession::handle_connect]connect_id={} ID to, io_bridge_connect_id:{},the bridge is set successfully.",
                    connect_id_, io_bridge_connect_id_);
            }
        }
