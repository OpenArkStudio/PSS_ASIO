...
int main()
{
    ...
    tcp_test_connect_synchronize_server("127.0.0.1", 10002, 10013, 0x2101, 1, io_context);
    tcp_test_connect_synchronize_server("127.0.0.1", 10002, 10014, 0x2102, 1, io_context);
